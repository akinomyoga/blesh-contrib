...
function ble/lib/vim-airline/theme:ravenpower/initialize {
  ...
  ble-face -s vim_airline_a                            fg=22,bg=16   # fg=#005f00,bg=#1d1f21
  ble-face -s vim_airline_a_inactive                   fg=236,bg=236 # fg=#303030,bg=#2e2e2e
  ble-face -s vim_airline_a_insert                     fg=117,bg=16  # fg=#87d7ff,bg=#1d1f21
  ...
  ble-face -s vim_airline_z_replace                    fg=22,bg=16   # fg=#005f00,bg=#1d1f21
}
