...
function ble/lib/vim-airline/theme:base16_edge_light/initialize {
  ...
  ble-face -s vim_airline_c_inactive                   fg=59,bg=107  # fg=#5e646f,bg=#7c9f4b
  ble-face -s vim_airline_c_insert_modified            fg=59,bg=107  # fg=#5e646f,bg=#7c9f4b
  ble-face -s vim_airline_c_normal_modified            fg=59,bg=107  # fg=#5e646f,bg=#7c9f4b
  ble-face -s vim_airline_c_replace_modified           fg=59,bg=107  # fg=#5e646f,bg=#7c9f4b
  ble-face -s vim_airline_c_visual_modified            fg=59,bg=107  # fg=#5e646f,bg=#7c9f4b
}
