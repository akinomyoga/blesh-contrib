...
function ble/lib/vim-airline/theme:base16_tomorrow_night_eighties/initialize {
  ...
  ble-face -s vim_airline_a                            fg=237,bg=145 # fg=#393939,bg=#b4b7b4
  ...
  ble-face -s vim_airline_b                            fg=145,bg=239 # fg=#b4b7b4,bg=#515151
  ble-face -s vim_airline_b_inactive                   fg=145,bg=237 # fg=#b4b7b4,bg=#393939
  ble-face -s vim_airline_c                            fg=145,bg=237 # fg=#b4b7b4,bg=#393939
