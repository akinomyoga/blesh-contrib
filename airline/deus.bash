...
function ble/lib/vim-airline/theme:deus/initialize {
  ...
  ble-face -s vim_airline_a_inactive                   fg=17,bg=145  # fg=#282c34,bg=#abb2bf
  ...
  ble-face -s vim_airline_b                            fg=145,bg=59  # fg=#abb2bf,bg=#3e4452
  ble-face -s vim_airline_c                            fg=114,bg=17  # fg=#98c379,bg=#282c34
  ble-face -s vim_airline_c_inactive                   fg=145,bg=59  # fg=#abb2bf,bg=#3e4452
