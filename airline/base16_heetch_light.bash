...
function ble/lib/vim-airline/theme:base16_heetch_light/initialize {
  ...
  ble-face -s vim_airline_a                            fg=53,bg=188  # fg=#392551,bg=#ddd6e5
  ...
  ble-face -s vim_airline_b                            fg=188,bg=96  # fg=#ddd6e5,bg=#7b6d8b
  ble-face -s vim_airline_b_inactive                   fg=188,bg=53  # fg=#ddd6e5,bg=#392551
  ble-face -s vim_airline_c                            fg=188,bg=53  # fg=#ddd6e5,bg=#392551
  ble-face -s vim_airline_c_inactive                   fg=59,bg=53   # fg=#5a496e,bg=#392551
