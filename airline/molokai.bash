...
function ble/lib/vim-airline/theme:molokai/initialize {
  ...
  ble-face -s vim_airline_a_inactive                   fg=16,bg=59   # fg=#1b1d1e,bg=#465457
  ...
  ble-face -s vim_airline_b                            fg=231,bg=16  # fg=#f8f8f0,bg=#232526
  ble-face -s vim_airline_b_inactive                   fg=16,bg=59   # fg=#1b1d1e,bg=#465457
  ble-face -s vim_airline_c                            fg=231,bg=59  # fg=#f8f8f0,bg=#465457
  ble-face -s vim_airline_c_inactive                   fg=16,bg=59   # fg=#1b1d1e,bg=#465457
  ble-face -s vim_airline_c_inactive_modified          fg=231,bg=0   # fg=#f8f8f0,bg=0
