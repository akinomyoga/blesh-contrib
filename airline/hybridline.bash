...
function ble/lib/vim-airline/theme:hybridline/initialize {
  ...
  ble-face -s vim_airline_b                            fg=188,bg=59  # fg=#c5c8c6,bg=#373b41
  ble-face -s vim_airline_b_inactive                   fg=239,bg=235 # fg=#4e4e4e,bg=#262626
  ble-face -s vim_airline_b_insert                     fg=188,bg=31  # fg=#c5c8c6,bg=#0087af
  ble-face -s vim_airline_b_replace                    fg=188,bg=59  # fg=#c5c8c6,bg=#373b41
  ble-face -s vim_airline_c                            fg=231,bg=16  # fg=#ffffff,bg=#282a2e
  ...
  ble-face -s vim_airline_c_replace                    fg=231,bg=16  # fg=#ffffff,bg=#282a2e
  ble-face -s vim_airline_z_normal                     fg=16,bg=188  # fg=#282a2e,bg=#c5c8c6
  ble-face -s vim_airline_z_replace                    fg=16,bg=188  # fg=#282a2e,bg=#c5c8c6
  ble-face -s vim_airline_z_visual                     fg=16,bg=188  # fg=#282a2e,bg=#c5c8c6
}
