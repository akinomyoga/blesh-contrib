...
function ble/lib/vim-airline/theme:base16_solarized_dark/initialize {
  ...
  ble-face -s vim_airline_a                            fg=23,bg=102  # fg=#073642,bg=#839496
  ...
  ble-face -s vim_airline_b                            fg=102,bg=60  # fg=#839496,bg=#586e75
  ble-face -s vim_airline_b_inactive                   fg=102,bg=23  # fg=#839496,bg=#073642
  ble-face -s vim_airline_c                            fg=102,bg=23  # fg=#839496,bg=#073642
