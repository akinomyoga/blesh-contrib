...
function ble/lib/vim-airline/theme:base16_darktooth/initialize {
  ...
  ble-face -s vim_airline_a                            fg=58,bg=102  # fg=#32302f,bg=#928374
  ...
  ble-face -s vim_airline_b                            fg=102,bg=59  # fg=#928374,bg=#504945
  ble-face -s vim_airline_b_inactive                   fg=102,bg=58  # fg=#928374,bg=#32302f
  ble-face -s vim_airline_c                            fg=102,bg=58  # fg=#928374,bg=#32302f
