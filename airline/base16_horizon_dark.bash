...
function ble/lib/vim-airline/theme:base16_horizon_dark/initialize {
  ...
  ble-face -s vim_airline_a                            fg=17,bg=145  # fg=#232530,bg=#9da0a2
  ...
  ble-face -s vim_airline_b                            fg=145,bg=23  # fg=#9da0a2,bg=#2e303e
  ble-face -s vim_airline_b_inactive                   fg=145,bg=17  # fg=#9da0a2,bg=#232530
  ble-face -s vim_airline_c                            fg=145,bg=17  # fg=#9da0a2,bg=#232530
  ble-face -s vim_airline_c_inactive                   fg=188,bg=17  # fg=#cbced0,bg=#232530
