...
function ble/lib/vim-airline/theme:base16_codeschool/initialize {
  ...
  ble-face -s vim_airline_a_inactive                   fg=145,bg=23  # fg=#9ea7a6,bg=#1c3657
  ...
  ble-face -s vim_airline_b_inactive                   fg=145,bg=23  # fg=#9ea7a6,bg=#1c3657
  ble-face -s vim_airline_c                            fg=64,bg=23   # fg=#43820d,bg=#1c3657
  ble-face -s vim_airline_c_inactive                   fg=145,bg=23  # fg=#9ea7a6,bg=#1c3657
}
