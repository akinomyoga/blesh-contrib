...
function ble/lib/vim-airline/theme:base16_brogrammer/initialize {
  ...
  ble-face -s vim_airline_c_insert_modified            fg=188,bg=196 # fg=#d6dbe5,bg=#f81118
  ble-face -s vim_airline_c_normal_modified            fg=188,bg=196 # fg=#d6dbe5,bg=#f81118
  ble-face -s vim_airline_c_replace_modified           fg=188,bg=196 # fg=#d6dbe5,bg=#f81118
  ble-face -s vim_airline_c_visual_modified            fg=188,bg=196 # fg=#d6dbe5,bg=#f81118
}
