...
function ble/lib/vim-airline/theme:base16_sandcastle/initialize {
  ...
  ble-face -s vim_airline_a                            fg=23,bg=102  # fg=#2c323b,bg=#928374
  ...
  ble-face -s vim_airline_b                            fg=102,bg=59  # fg=#928374,bg=#3e4451
  ble-face -s vim_airline_b_inactive                   fg=102,bg=23  # fg=#928374,bg=#2c323b
  ble-face -s vim_airline_c                            fg=102,bg=23  # fg=#928374,bg=#2c323b
