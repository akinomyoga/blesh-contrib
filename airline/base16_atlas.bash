...
function ble/lib/vim-airline/theme:base16_atlas/initialize {
  ...
  ble-face -s vim_airline_a                            fg=23,bg=102  # fg=#00384d,bg=#869696
  ...
  ble-face -s vim_airline_b                            fg=102,bg=66  # fg=#869696,bg=#517f8d
  ble-face -s vim_airline_b_inactive                   fg=102,bg=23  # fg=#869696,bg=#00384d
  ble-face -s vim_airline_c                            fg=102,bg=23  # fg=#869696,bg=#00384d
