...
function ble/lib/vim-airline/theme:google_light/initialize {
  ...
  ble-face -s vim_airline_b                            fg=241,bg=189 # fg=#5f6368,bg=#e8eaed
  ...
  ble-face -s vim_airline_c_inactive_modified          fg=235,bg=231 # fg=#202124,bg=#ffffff
  ble-face -s vim_airline_c_insert                     fg=69,bg=231  # fg=#4285f4,bg=#ffffff
  ble-face -s vim_airline_c_insert_modified            fg=235,bg=231 # fg=#202124,bg=#ffffff
  ble-face -s vim_airline_c_normal_modified            fg=235,bg=231 # fg=#202124,bg=#ffffff
  ble-face -s vim_airline_c_replace                    fg=167,bg=231 # fg=#ea4335,bg=#ffffff
  ble-face -s vim_airline_c_replace_modified           fg=235,bg=231 # fg=#202124,bg=#ffffff
  ble-face -s vim_airline_c_visual                     fg=214,bg=231 # fg=#fbbc04,bg=#ffffff
  ble-face -s vim_airline_c_visual_modified            fg=235,bg=231 # fg=#202124,bg=#ffffff
}
