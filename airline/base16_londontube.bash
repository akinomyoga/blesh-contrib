...
function ble/lib/vim-airline/theme:base16_londontube/initialize {
  ...
  ble-face -s vim_airline_a_inactive                   fg=188,bg=24  # fg=#d9d8d8,bg=#1c3f95
  ...
  ble-face -s vim_airline_b                            fg=188,bg=59  # fg=#e7e7e8,bg=#5a5758
  ble-face -s vim_airline_b_inactive                   fg=188,bg=24  # fg=#d9d8d8,bg=#1c3f95
  ble-face -s vim_airline_c                            fg=211,bg=24  # fg=#f386a1,bg=#1c3f95
  ble-face -s vim_airline_c_inactive                   fg=188,bg=24  # fg=#d9d8d8,bg=#1c3f95
}
