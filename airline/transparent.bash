...
function ble/lib/vim-airline/theme:transparent/initialize {
  ...
  ble-face -s vim_airline_a_inactive                   fg=234,bg=-1  # fg=#1d1f21,bg=-1
  ...
  ble-face -s vim_airline_b                            fg=239,bg=-1  # fg=#3f4b59,bg=-1
  ble-face -s vim_airline_b_inactive                   fg=234,bg=-1  # fg=#1d1f21,bg=-1
  ble-face -s vim_airline_c                            fg=239,bg=-1  # fg=#3f4b59,bg=-1
  ...
  ble-face -s vim_airline_x_inactive                   fg=234,bg=-1  # fg=#1d1f21,bg=-1
  ble-face -s vim_airline_z_insert                     fg=150,bg=-1  # fg=#bbe67e,bg=-1
  ble-face -s vim_airline_z_normal                     fg=239,bg=-1  # fg=#3f4b59,bg=-1
