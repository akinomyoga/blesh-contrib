...
function ble/lib/vim-airline/theme:supernova/initialize {
  ...
  ble-face -s vim_airline_a_visual                     fg=16,bg=254  # fg=#1d2529,bg=#e4e4e4
  ...
  ble-face -s vim_airline_c                            fg=255,bg=16  # fg=#eeeeee,bg=#1d2529
  ...
  ble-face -s vim_airline_c_visual                     fg=254,bg=16  # fg=#e4e4e4,bg=#1d2529
