...
function ble/lib/vim-airline/theme:luna/initialize {
  ...
  ble-face -s vim_airline_a_inactive                   fg=239,bg=16  # fg=#4e4e4e,bg=#002b2b
  ...
  ble-face -s vim_airline_b_inactive                   fg=239,bg=16  # fg=#4e4e4e,bg=#002b2b
  ble-face -s vim_airline_c                            fg=231,bg=16  # fg=#ffffff,bg=#002b2b
  ble-face -s vim_airline_c_inactive                   fg=239,bg=16  # fg=#4e4e4e,bg=#002b2b
  ble-face -s vim_airline_c_inactive_modified          fg=160,bg=0   # fg=#e20000,bg=0
