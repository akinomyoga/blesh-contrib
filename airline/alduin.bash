...
function ble/lib/vim-airline/theme:alduin/initialize {
  ...
  ble-face -s vim_airline_c_inactive_modified          fg=222,bg=0   # fg=#ffdf87,bg=0
  ble-face -s vim_airline_c_insert                     fg=231,bg=138 # fg=#ffffff,bg=#af8787
  ble-face -s vim_airline_c_insert_modified            fg=222,bg=0   # fg=#ffdf87,bg=0
  ble-face -s vim_airline_c_normal_modified            fg=222,bg=0   # fg=#ffdf87,bg=0
  ble-face -s vim_airline_c_replace_modified           fg=222,bg=0   # fg=#ffdf87,bg=0
  ble-face -s vim_airline_c_visual                     fg=231,bg=138 # fg=#ffffff,bg=#af8787
  ble-face -s vim_airline_c_visual_modified            fg=222,bg=0   # fg=#ffdf87,bg=0
}
