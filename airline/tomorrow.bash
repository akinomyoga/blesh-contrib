...
function ble/lib/vim-airline/theme:tomorrow/initialize {
  ...
  ble-face -s vim_airline_a                            fg=-1,bg=21   # fg=-1,bg=#0000ff
  ...
  ble-face -s vim_airline_a_visual                     fg=-1,bg=201  # fg=-1,bg=#ff00ff
  ble-face -s vim_airline_b                            fg=-1,bg=213  # fg=-1,bg=#ff8bff
  ble-face -s vim_airline_b_inactive                   fg=21,bg=254  # fg=#0000ff,bg=#e5e5e5
  ble-face -s vim_airline_b_insert                     fg=29,bg=-1   # fg=#2e8b57,bg=-1
  ble-face -s vim_airline_b_replace                    fg=-1,bg=213  # fg=-1,bg=#ff8bff
