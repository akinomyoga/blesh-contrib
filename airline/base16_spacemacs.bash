...
function ble/lib/vim-airline/theme:base16_spacemacs/initialize {
  ...
  ble-face -s vim_airline_a_inactive                   fg=250,bg=59  # fg=#b8b8b8,bg=#444155
  ...
  ble-face -s vim_airline_b                            fg=254,bg=59  # fg=#e8e8e8,bg=#444155
  ble-face -s vim_airline_b_inactive                   fg=250,bg=59  # fg=#b8b8b8,bg=#444155
  ble-face -s vim_airline_c                            fg=254,bg=16  # fg=#e8e8e8,bg=#1f2022
  ble-face -s vim_airline_c_inactive                   fg=250,bg=59  # fg=#b8b8b8,bg=#444155
  ble-face -s vim_airline_c_insert                     fg=70,bg=16   # fg=#67b11d,bg=#1f2022
  ble-face -s vim_airline_c_replace                    fg=254,bg=16  # fg=#e8e8e8,bg=#1f2022
  ble-face -s vim_airline_c_visual                     fg=214,bg=16  # fg=#ffa500,bg=#1f2022
