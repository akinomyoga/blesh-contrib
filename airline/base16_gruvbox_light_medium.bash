# From github:vim-airline/vim-airline-themes/autoload/airline/themes/base16_gruvbox_light_medium.vim
#   The MIT License (MIT)
...
function ble/lib/vim-airline/theme:base16_gruvbox_light_medium/initialize {
  ble-face -r vim_airline_@
  ble-face -s vim_airline_a                            fg=223,bg=59  # fg=#ebdbb2,bg=#665c54
  ...
  ble-face -s vim_airline_b                            fg=59,bg=187  # fg=#665c54,bg=#d5c4a1
  ble-face -s vim_airline_b_inactive                   fg=59,bg=223  # fg=#665c54,bg=#ebdbb2
  ble-face -s vim_airline_c                            fg=59,bg=223  # fg=#665c54,bg=#ebdbb2
  ble-face -s vim_airline_c_inactive                   fg=59,bg=223  # fg=#504945,bg=#ebdbb2
