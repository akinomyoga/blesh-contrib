...
function ble/lib/vim-airline/theme:base16_rebecca/initialize {
  ...
  ble-face -s vim_airline_b                            fg=146,bg=59  # fg=#a0a0c5,bg=#383a62
  ...
  ble-face -s vim_airline_c_inactive                   fg=231,bg=60  # fg=#f1eff8,bg=#663399
  ble-face -s vim_airline_c_insert_modified            fg=59,bg=60   # fg=#53495d,bg=#663399
  ble-face -s vim_airline_c_normal_modified            fg=59,bg=60   # fg=#53495d,bg=#663399
  ble-face -s vim_airline_c_replace_modified           fg=59,bg=60   # fg=#53495d,bg=#663399
  ble-face -s vim_airline_c_visual_modified            fg=59,bg=60   # fg=#53495d,bg=#663399
}
