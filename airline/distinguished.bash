...
function ble/lib/vim-airline/theme:distinguished/initialize {
  ...
  ble-face -s vim_airline_a_normal_modified            fg=0,bg=166   # fg=0,bg=#d75f00
  ...
  ble-face -s vim_airline_c_normal_modified            fg=166,bg=0   # fg=#d75f00,bg=0
  ...
  ble-face -s vim_airline_x_normal_modified            fg=166,bg=0   # fg=#d75f00,bg=0
  ble-face -s vim_airline_z_normal_modified            fg=0,bg=166   # fg=0,bg=#d75f00
}
