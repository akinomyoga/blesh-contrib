...
function ble/lib/vim-airline/theme:base16_woodland/initialize {
  ...
  ble-face -s vim_airline_b                            fg=144,bg=59  # fg=#b4a490,bg=#48413a
  ...
  ble-face -s vim_airline_c_insert_modified            fg=188,bg=52  # fg=#e4d4c8,bg=#302b25
  ble-face -s vim_airline_c_normal_modified            fg=188,bg=52  # fg=#e4d4c8,bg=#302b25
  ble-face -s vim_airline_c_replace_modified           fg=188,bg=52  # fg=#e4d4c8,bg=#302b25
  ble-face -s vim_airline_c_visual_modified            fg=188,bg=52  # fg=#e4d4c8,bg=#302b25
}
