# From github:vim-airline/vim-airline-themes/autoload/airline/themes/base16_black_metal_khold.vim
#   The MIT License (MIT)
...
function ble/lib/vim-airline/theme:base16_black_metal_khold/initialize {
  ...
  ble-face -s vim_airline_a_insert                     fg=233,bg=230 # fg=#121212,bg=#eceee3
