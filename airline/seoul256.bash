...
function ble/lib/vim-airline/theme:seoul256/initialize {
  ...
  ble-face -s vim_airline_a_inactive                   fg=-1,bg=254  # fg=-1,bg=#e5e5e5
  ble-face -s vim_airline_a_replace                    fg=-1,bg=29   # fg=-1,bg=#2e8b57
  ble-face -s vim_airline_a_visual                     fg=-1,bg=196  # fg=-1,bg=#ff0000
  ble-face -s vim_airline_b                            fg=-1,bg=-1   # fg=-1,bg=-1
  ble-face -s vim_airline_b_inactive                   fg=-1,bg=254  # fg=-1,bg=#e5e5e5
  ble-face -s vim_airline_c                            fg=-1,bg=254  # fg=-1,bg=#e5e5e5
  ble-face -s vim_airline_c_inactive_modified          fg=62,bg=0    # fg=#6a5acd,bg=0
  ble-face -s vim_airline_c_insert                     fg=-1,bg=-1   # fg=-1,bg=-1
  ble-face -s vim_airline_c_insert_modified            fg=62,bg=0    # fg=#6a5acd,bg=0
  ble-face -s vim_airline_c_normal_modified            fg=62,bg=0    # fg=#6a5acd,bg=0
  ble-face -s vim_airline_c_replace_modified           fg=62,bg=0    # fg=#6a5acd,bg=0
