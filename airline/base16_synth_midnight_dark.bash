...
function ble/lib/vim-airline/theme:base16_synth_midnight_dark/initialize {
  ...
  ble-face -s vim_airline_a                            fg=233,bg=145 # fg=#141414,bg=#bfbbbf
  ...
  ble-face -s vim_airline_b                            fg=145,bg=235 # fg=#bfbbbf,bg=#242424
  ble-face -s vim_airline_b_inactive                   fg=145,bg=233 # fg=#bfbbbf,bg=#141414
  ble-face -s vim_airline_c                            fg=145,bg=233 # fg=#bfbbbf,bg=#141414
  ble-face -s vim_airline_c_inactive                   fg=188,bg=233 # fg=#dfdbdf,bg=#141414
