...
function ble/lib/vim-airline/theme:base16_edge_dark/initialize {
  ...
  ble-face -s vim_airline_c_insert_modified            fg=59,bg=103  # fg=#3e4249,bg=#88909f
  ble-face -s vim_airline_c_normal_modified            fg=59,bg=103  # fg=#3e4249,bg=#88909f
  ble-face -s vim_airline_c_replace_modified           fg=59,bg=103  # fg=#3e4249,bg=#88909f
  ble-face -s vim_airline_c_visual_modified            fg=59,bg=103  # fg=#3e4249,bg=#88909f
}
