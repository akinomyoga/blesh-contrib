...
function ble/lib/vim-airline/theme:base16_materia/initialize {
  ...
  ble-face -s vim_airline_a                            fg=23,bg=188  # fg=#2c393f,bg=#c9ccd3
  ...
  ble-face -s vim_airline_b                            fg=188,bg=59  # fg=#c9ccd3,bg=#37474f
  ble-face -s vim_airline_b_inactive                   fg=188,bg=23  # fg=#c9ccd3,bg=#2c393f
  ble-face -s vim_airline_c                            fg=188,bg=23  # fg=#c9ccd3,bg=#2c393f
  ble-face -s vim_airline_c_inactive                   fg=188,bg=23  # fg=#cdd3de,bg=#2c393f
