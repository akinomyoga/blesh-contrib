...
function ble/lib/vim-airline/theme:base16_atelier_lakeside_light/initialize {
  ...
  ble-face -s vim_airline_c_insert_modified            fg=16,bg=153  # fg=#161b1d,bg=#c1e4f6
  ble-face -s vim_airline_c_normal_modified            fg=16,bg=153  # fg=#161b1d,bg=#c1e4f6
  ble-face -s vim_airline_c_replace_modified           fg=16,bg=153  # fg=#161b1d,bg=#c1e4f6
  ble-face -s vim_airline_c_visual_modified            fg=16,bg=153  # fg=#161b1d,bg=#c1e4f6
}
