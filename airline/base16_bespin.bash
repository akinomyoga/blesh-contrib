...
function ble/lib/vim-airline/theme:base16_bespin/initialize {
  ...
  ble-face -s vim_airline_a_inactive                   fg=102,bg=58  # fg=#8a8986,bg=#36312e
  ...
  ble-face -s vim_airline_b                            fg=144,bg=59  # fg=#9d9b97,bg=#5e5d5c
  ble-face -s vim_airline_b_inactive                   fg=102,bg=58  # fg=#8a8986,bg=#36312e
  ble-face -s vim_airline_c                            fg=173,bg=58  # fg=#cf7d34,bg=#36312e
  ble-face -s vim_airline_c_inactive                   fg=102,bg=58  # fg=#8a8986,bg=#36312e
}
