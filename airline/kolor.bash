...
function ble/lib/vim-airline/theme:kolor/initialize {
  ...
  ble-face -s vim_airline_a_insert                     fg=16,bg=111  # fg=#242322,bg=#7eaefd
  ble-face -s vim_airline_a_replace                    fg=116,bg=23  # fg=#75d7d8,bg=#005154
  ble-face -s vim_airline_a_visual                     fg=16,bg=174  # fg=#242322,bg=#e6987a
  ble-face -s vim_airline_b                            fg=206,bg=16  # fg=#ff5fd7,bg=#242322
  ble-face -s vim_airline_b_inactive                   fg=249,bg=239 # fg=#b2b2b2,bg=#4a4a4a
  ble-face -s vim_airline_b_insert                     fg=116,bg=16  # fg=#75d7d8,bg=#242322
  ble-face -s vim_airline_b_visual                     fg=185,bg=16  # fg=#dbc570,bg=#242322
  ...
  ble-face -s vim_airline_c_insert_modified            fg=16,bg=111  # fg=#242322,bg=#7eaefd
  ...
  ble-face -s vim_airline_c_visual_modified            fg=16,bg=174  # fg=#242322,bg=#e6987a
  ble-face -s vim_airline_z_replace                    fg=16,bg=111  # fg=#242322,bg=#7eaefd
}
