...
function ble/lib/vim-airline/theme:base16_harmonic16/initialize {
  ...
  ble-face -s vim_airline_a_inactive                   fg=188,bg=23  # fg=#cbd6e2,bg=#223b54
  ...
  ble-face -s vim_airline_b_inactive                   fg=188,bg=23  # fg=#cbd6e2,bg=#223b54
  ble-face -s vim_airline_c                            fg=143,bg=23  # fg=#bfbf56,bg=#223b54
  ble-face -s vim_airline_c_inactive                   fg=188,bg=23  # fg=#cbd6e2,bg=#223b54
}
