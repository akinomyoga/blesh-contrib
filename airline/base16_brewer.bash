...
function ble/lib/vim-airline/theme:base16_brewer/initialize {
  ...
  ble-face -s vim_airline_a_inactive                   fg=145,bg=17  # fg=#b7b8b9,bg=#2e2f30
  ...
  ble-face -s vim_airline_b                            fg=188,bg=59  # fg=#dadbdc,bg=#515253
  ble-face -s vim_airline_b_inactive                   fg=145,bg=17  # fg=#b7b8b9,bg=#2e2f30
  ble-face -s vim_airline_c                            fg=166,bg=17  # fg=#e6550d,bg=#2e2f30
  ble-face -s vim_airline_c_inactive                   fg=145,bg=17  # fg=#b7b8b9,bg=#2e2f30
}
