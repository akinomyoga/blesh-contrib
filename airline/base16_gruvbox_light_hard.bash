# From github:vim-airline/vim-airline-themes/autoload/airline/themes/base16_gruvbox_light_hard.vim
#   The MIT License (MIT)
...
function ble/lib/vim-airline/theme:base16_gruvbox_light_hard/initialize {
