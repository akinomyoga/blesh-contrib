...
function ble/lib/vim-airline/theme:base16_railscasts/initialize {
  ...
  ble-face -s vim_airline_a_inactive                   fg=188,bg=17  # fg=#e6e1dc,bg=#272935
  ...
  ble-face -s vim_airline_b                            fg=231,bg=59  # fg=#f4f1ed,bg=#3a4055
  ble-face -s vim_airline_b_inactive                   fg=188,bg=17  # fg=#e6e1dc,bg=#272935
  ble-face -s vim_airline_c                            fg=173,bg=17  # fg=#cc7833,bg=#272935
  ble-face -s vim_airline_c_inactive                   fg=188,bg=17  # fg=#e6e1dc,bg=#272935
}
