...
function ble/lib/vim-airline/theme:seagull/initialize {
  ...
  ble-face -s vim_airline_a_inactive                   fg=189,bg=102 # fg=#e6eaed,bg=#787e82
  ...
  ble-face -s vim_airline_b_inactive                   fg=189,bg=102 # fg=#e6eaed,bg=#787e82
  ble-face -s vim_airline_c                            fg=102,bg=189 # fg=#808487,bg=#e6eaed
  ble-face -s vim_airline_c_inactive                   fg=189,bg=102 # fg=#e6eaed,bg=#787e82
  ble-face -s vim_airline_c_inactive_modified          fg=16,bg=0    # fg=#1d252b,bg=0
