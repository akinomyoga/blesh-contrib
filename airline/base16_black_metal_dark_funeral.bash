# From github:vim-airline/vim-airline-themes/autoload/airline/themes/base16_black_metal_dark_funeral.vim
#   The MIT License (MIT)
...
function ble/lib/vim-airline/theme:base16_black_metal_dark_funeral/initialize {
  ...
  ble-face -s vim_airline_a_insert                     fg=233,bg=189 # fg=#121212,bg=#d0dfee
