...
function ble/lib/vim-airline/theme:base16_eighties/initialize {
  ...
  ble-face -s vim_airline_a_inactive                   fg=188,bg=237 # fg=#d3d0c8,bg=#393939
  ...
  ble-face -s vim_airline_b                            fg=188,bg=239 # fg=#e8e6df,bg=#515151
  ble-face -s vim_airline_b_inactive                   fg=188,bg=237 # fg=#d3d0c8,bg=#393939
  ble-face -s vim_airline_c                            fg=209,bg=237 # fg=#f99157,bg=#393939
  ble-face -s vim_airline_c_inactive                   fg=188,bg=237 # fg=#d3d0c8,bg=#393939
}
