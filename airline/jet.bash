...
function ble/lib/vim-airline/theme:jet/initialize {
  ...
  ble-face -s vim_airline_a                            fg=188,bg=25  # fg=#d8dee9,bg=#0d61ac
  ...
  ble-face -s vim_airline_b_inactive                   fg=59,bg=233  # fg=#4f5b66,bg=#151515
  ble-face -s vim_airline_b_insert                     fg=59,bg=235  # fg=#4f5b66,bg=#262626
  ble-face -s vim_airline_b_visual                     fg=59,bg=235  # fg=#4f5b66,bg=#262626
  ble-face -s vim_airline_c                            fg=59,bg=233  # fg=#4f5b66,bg=#151515
