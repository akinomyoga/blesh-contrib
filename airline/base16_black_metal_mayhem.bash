# From github:vim-airline/vim-airline-themes/autoload/airline/themes/base16_black_metal_mayhem.vim
#   The MIT License (MIT)
...
function ble/lib/vim-airline/theme:base16_black_metal_mayhem/initialize {
  ...
  ble-face -s vim_airline_a_insert                     fg=233,bg=230 # fg=#121212,bg=#f3ecd4
