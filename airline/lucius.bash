...
function ble/lib/vim-airline/theme:lucius/initialize {
  ...
  ble-face -s vim_airline_a_insert                     fg=-1,bg=152  # fg=-1,bg=#add8e6
  ble-face -s vim_airline_a_replace                    fg=-1,bg=225  # fg=-1,bg=#ffe0ff
  ...
  ble-face -s vim_airline_c_inactive_modified          fg=124,bg=0   # fg=#a52a2a,bg=0
  ble-face -s vim_airline_c_insert_modified            fg=124,bg=0   # fg=#a52a2a,bg=0
  ble-face -s vim_airline_c_normal_modified            fg=124,bg=0   # fg=#a52a2a,bg=0
  ble-face -s vim_airline_c_replace_modified           fg=124,bg=0   # fg=#a52a2a,bg=0
  ble-face -s vim_airline_c_visual_modified            fg=124,bg=0   # fg=#a52a2a,bg=0
  ...
  ble-face -s vim_airline_warning                      fg=-1,bg=225  # fg=-1,bg=#ffe0ff
