...
function ble/lib/vim-airline/theme:base16_harmonic_light/initialize {
  ...
  ble-face -s vim_airline_b                            fg=66,bg=188  # fg=#627e99,bg=#cbd6e2
  ...
  ble-face -s vim_airline_c_insert_modified            fg=16,bg=195  # fg=#0b1c2c,bg=#e5ebf1
  ble-face -s vim_airline_c_normal_modified            fg=16,bg=195  # fg=#0b1c2c,bg=#e5ebf1
  ble-face -s vim_airline_c_replace_modified           fg=16,bg=195  # fg=#0b1c2c,bg=#e5ebf1
  ble-face -s vim_airline_c_visual_modified            fg=16,bg=195  # fg=#0b1c2c,bg=#e5ebf1
}
