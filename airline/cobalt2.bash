...
function ble/lib/vim-airline/theme:cobalt2/initialize {
  ...
  ble-face -s vim_airline_a_insert                     fg=59,bg=221  # fg=#666d51,bg=#fee533
  ...
  ble-face -s vim_airline_c_inactive_modified          fg=125,bg=0   # fg=#b42839,bg=0
  ble-face -s vim_airline_c_insert_modified            fg=59,bg=221  # fg=#666d51,bg=#fee533
