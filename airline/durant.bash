...
function ble/lib/vim-airline/theme:durant/initialize {
  ...
  ble-face -s vim_airline_a_visual                     fg=16,bg=231  # fg=#1a1a18,bg=#ffffff
  ...
  ble-face -s vim_airline_b_visual                     fg=231,bg=59  # fg=#ffffff,bg=#44403a
  ...
  ble-face -s vim_airline_c_visual                     fg=108,bg=16  # fg=#90a680,bg=#2e2d2a
