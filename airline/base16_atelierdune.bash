...
function ble/lib/vim-airline/theme:base16_atelierdune/initialize {
  ...
  ble-face -s vim_airline_a                            fg=16,bg=71   # fg=#292824,bg=#60ac39
  ble-face -s vim_airline_a_inactive                   fg=144,bg=16  # fg=#a6a28c,bg=#292824
  ble-face -s vim_airline_a_insert                     fg=16,bg=68   # fg=#292824,bg=#6684e1
  ble-face -s vim_airline_a_replace                    fg=16,bg=167  # fg=#292824,bg=#d73737
  ble-face -s vim_airline_a_visual                     fg=16,bg=134  # fg=#292824,bg=#b854d4
  ble-face -s vim_airline_b                            fg=188,bg=59  # fg=#e8e4cf,bg=#6e6b5e
  ble-face -s vim_airline_b_inactive                   fg=144,bg=16  # fg=#a6a28c,bg=#292824
  ble-face -s vim_airline_c                            fg=130,bg=16  # fg=#b65611,bg=#292824
  ...
  ble-face -s vim_airline_warning                      fg=16,bg=178  # fg=#292824,bg=#cfb017
