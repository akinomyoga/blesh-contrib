...
function ble/lib/vim-airline/theme:selenized/initialize {
  ...
  ble-face -s vim_airline_a_inactive                   fg=102,bg=181 # fg=#7e8783,bg=#cbc2a6
  ...
  ble-face -s vim_airline_b                            fg=59,bg=181  # fg=#43545a,bg=#cbc2a6
  ble-face -s vim_airline_b_inactive                   fg=102,bg=181 # fg=#7e8783,bg=#cbc2a6
  ble-face -s vim_airline_c                            fg=102,bg=187 # fg=#7e8783,bg=#e7ddc0
  ble-face -s vim_airline_c_inactive                   fg=102,bg=181 # fg=#7e8783,bg=#cbc2a6
